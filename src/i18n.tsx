...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  nl: {
    ...
    "pricingBannerTier3": "Vanaf 5 cat.",
    "pricingBannerCancel": "Maandelijks opzegbaar · 3 dagen opzegtermijn tegen het einde van de maand (zoals bij het Premium-account)",
