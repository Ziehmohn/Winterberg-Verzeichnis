...
export const translations: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "pricingMainSubtitle": "Der Basiseintrag ist dauerhaft kostenlos und umfasst bis zu 3 Leistungen & 3 Produkte für Suche und Profil. Premium schaltet bis zu 15 Leistungen & 15 Produkte, Hero-Header, kategorisierte Bildergalerie, Öffnungszeiten, ausführliches Profil, Stellenanzeigen, News-Publikation, White-Label Bewertungs-Widgets und die Top-Platzierung frei.",
  ...
  nl: {
    ...
    "pricingMainSubtitle": "De basisvermelding is blijvend gratis en bevat tot 3 diensten & 3 producten voor zoekfunctie en profiel. Premium ontgrendelt tot 15 diensten & 15 producten, een hero-header, gecategoriseerde fotogalerij, openingstijden, uitgebreid profiel, vacatures, nieuwspublicaties, white-label beoordelingswidgets en topplaatsing.",
