        ...
        <div className="bg-white border border-[#EDE8E0] rounded-[22px] p-[30px]">
          ...
          {!hideAction && (
            <button 
              ...
              className="mt-[26px] w-full bg-white text-[#D65F0C] border-2 border-[#F2761B] rounded-full py-[13px] text-[15px] font-semibold cursor-pointer hover:bg-[#FFF1E4] transition-colors"
            >
        ...
        <div className="bg-white border-2 border-[#F2761B] rounded-[22px] p-[30px] shadow-[0_16px_40px_rgba(242,118,27,0.14)] relative">
          ...
          {!hideAction && (
            <button 
              ...
              className="mt-[26px] w-full bg-[#F2761B] hover:bg-[#D65F0C] text-white border-none rounded-full py-[13px] text-[15px] font-semibold cursor-pointer transition-colors shadow-[0_4px_14px_rgba(242,118,27,0.3)]"
            >
              Premium wählen
            </button>
          )}
