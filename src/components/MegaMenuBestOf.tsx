                    ...
                    <div>
                      <h2 className="font-display text-xl font-bold text-[#1B211D] flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="text-[11px] font-bold bg-[#E8F1EB] hover:bg-[#D6E7DC] text-[#0F4C2E] px-2.5 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1 transition-colors cursor-pointer"
                          title="Wie wird der Score berechnet? Hier klicken"
                        >
                          <span>{isNl ? 'Klantrecensies' : 'Bewertungsbasiert'}</span>
                ...
                <div className="mt-8 pt-5 border-t border-[#EDE8E0] bg-[#FAF8F5] rounded-xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs text-[#5F6B63]">
                  ...
                  <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
                    <button
                      type="button"
                      onClick={() => openInfoModal('score')}
                      className="inline-flex items-center gap-1 text-[#0F4C2E] hover:text-[#F2761B] font-bold underline transition-colors cursor-pointer text-xs"
                    >
                      <Scale className="w-3.5 h-3.5" />
                      <span>{isNl ? 'Uitleg Kwaliteitsscore' : 'Score-Erklärung'}</span>
                      <HelpCircle className="w-3 h-3" />
                    </button>
                  </div>
                </div>
